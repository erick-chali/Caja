		    	...
		    	<div class="panel panel-default"> 
		    		<div class="panel-body">
		    			<div class="table-responsive previasFacturas">
							<table id="tablaFacturas" data-search="true" data-classes="table table-condensed">
								<thead>
								<tr>
									<th data-field="serie" data-sortable="true">Serie</th>
									<th data-field="numeroFactura" data-sortable="true">#Fac.</th>
									<th data-field="nit" data-sortable="true">NIT</th>
									<th data-field="nombreFactura" data-sortable="true">Nombre</th>
									<th data-field="fechaFormato" data-sortable="true">Fecha</th>
									<th data-field="monto" data-sortable="true" data-visible="false">Monto</th>
									<th data-field="observaciones" data-sortable="true" data-visible="false">Observ.</th>
									<th data-field="tipoPago" data-sortable="true" data-visible="false">Pago</th>
								</tr>
								</thead>
							</table>
						</div>
		    ...
		    <div class="col-sm-8 col-md-8 col-lg-8 vistaDetalle">
		    	<div class="panel panel-default">
		    		<div class="panel-body" style="height: 600px;">
		    			...
		    			<div class="row">
		    				<div class="col-sm-12 col-md-12 col-lg-12">
		    					<div class="table-responsive facturasDetalladas">
								</div>
		    				</div>
	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
	        	...
	        	<div class="row">
	        		...
	        		<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
	        			<input type="text" id="montoTarjeta" class="form-control input-sm">
	        		</div>
